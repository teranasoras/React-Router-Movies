...
* [ ] Still inside cde `client` folder run `npm start` to run the client application.
...
* [x] You should now be able to navigate back and forth between the list of movikines and the detailed view of a single movie.
